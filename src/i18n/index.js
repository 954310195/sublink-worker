...
export const translations = {
  'zh-CN': {
    ...
    dialerProxyRules: '链式出站规则',
    dialerProxyRulesTip: '从已识别节点中挑选要走链式出站的节点，并为每组节点指定一个上游节点或策略组。',
    addDialerProxyRule: '添加链式规则',
    detectedNodes: '已识别节点',
    detectingNodes: '正在识别节点',
    noDetectedNodes: '当前输入里还没有识别到可选节点。',
    noDialerProxyRules: '暂未添加链式规则。',
    chainRule: '规则',
    chainTarget: '上游节点 / 策略组',
    selectChainTarget: '请选择上游节点或策略组',
    chainTargetPlaceholder: '例如：中转组 或 Relay-Select',
    selectNodes: '选择要套链的节点',
    dialerProxy: '链式出站节点',
    dialerProxyPlaceholder: '输入上游节点或策略组名称',
    dialerProxyTip: '仅对 Mihomo / Stash / Sing-Box 输出生效。Clash 和 Stash 使用 dialer-proxy，Sing-Box 使用 detour。',
  ...
  'en-US': {
    ...
    dialerProxyRules: 'Chain Rules',
    dialerProxyRulesTip: 'Pick detected nodes and assign an upstream proxy or group for each rule.',
    addDialerProxyRule: 'Add Chain Rule',
    detectedNodes: 'Detected Nodes',
    detectingNodes: 'Detecting nodes',
    noDetectedNodes: 'No selectable nodes have been detected from the current input yet.',
    noDialerProxyRules: 'No chain rules added yet.',
    chainRule: 'Rule',
    chainTarget: 'Upstream Proxy / Group',
    selectChainTarget: 'Select an upstream proxy or group',
    chainTargetPlaceholder: 'e.g. Relay-Select',
    selectNodes: 'Select Nodes to Chain',
    dialerProxy: 'Chain Outbound',
    dialerProxyPlaceholder: 'Enter an upstream proxy or group name',
    dialerProxyTip: 'Only applies to Mihomo, Stash, and Sing-Box outputs. Clash/Stash use dialer-proxy, Sing-Box uses detour.',
  ...
  'fa': {
    ...
    dialerProxyRules: 'قوانین زنجیره خروجی',
    dialerProxyRulesTip: 'از میان گره‌های شناسایی‌شده انتخاب کنید و برای هر قانون یک پراکسی یا گروه بالادستی تعیین کنید.',
    addDialerProxyRule: 'افزودن قانون زنجیره',
    detectedNodes: 'گره‌های شناسایی‌شده',
    detectingNodes: 'در حال شناسایی گره‌ها',
    noDetectedNodes: 'هنوز گره قابل انتخابی از ورودی فعلی شناسایی نشده است.',
    noDialerProxyRules: 'هنوز قانون زنجیره‌ای اضافه نشده است.',
    chainRule: 'قانون',
    chainTarget: 'پراکسی / گروه بالادستی',
    selectChainTarget: 'پراکسی یا گروه بالادستی را انتخاب کنید',
    chainTargetPlaceholder: 'مثلاً Relay-Select',
    selectNodes: 'انتخاب گره‌های زنجیره‌ای',
    dialerProxy: 'خروجی زنجیره‌ای',
    dialerProxyPlaceholder: 'نام پراکسی یا گروه بالادستی را وارد کنید',
    dialerProxyTip: 'فقط برای خروجی‌های Mihomo، Stash و Sing-Box اعمال می‌شود. Clash و Stash از dialer-proxy و Sing-Box از detour استفاده می‌کنند.',
  ...
  'ru': {
    ...
    dialerProxyRules: 'Правила цепочки',
    dialerProxyRulesTip: 'Выберите обнаруженные узлы и укажите вышестоящий прокси или группу для каждого правила.',
    addDialerProxyRule: 'Добавить правило',
    detectedNodes: 'Обнаруженные узлы',
    detectingNodes: 'Обнаружение узлов',
    noDetectedNodes: 'Пока не обнаружено подходящих узлов в текущем вводе.',
    noDialerProxyRules: 'Правила цепочки еще не добавлены.',
    chainRule: 'Правило',
    chainTarget: 'Вышестоящий прокси / группа',
    selectChainTarget: 'Выберите вышестоящий прокси или группу',
    chainTargetPlaceholder: 'например Relay-Select',
    selectNodes: 'Выберите узлы для цепочки',
    dialerProxy: 'Цепочный выход',
    dialerProxyPlaceholder: 'Введите имя вышестоящего прокси или группы',
    dialerProxyTip: 'Применяется только к выводу Mihomo, Stash и Sing-Box. Clash и Stash используют dialer-proxy, Sing-Box использует detour.',
